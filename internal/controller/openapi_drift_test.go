...
var expectedOpenAPIProblemCatalog = map[string]openAPIProblemCode{
	...
	"authorization_identity_mismatch": {Description: "GitHub authorization used a different identity than the saved connection", Statuses: []int{409}},
	"authorization_superseded":        {Description: "A newer GitHub authorization replaced this attempt", Statuses: []int{409}},
	"authorization_failed":            {Description: "GitHub authorization could not be completed", Statuses: []int{409}},
	...
	"reviewed_revision_stale":         {Description: "The reviewed deployment plan or configuration changed before deployment", Statuses: []int{409}},
	"reviewed_revisions_required":     {Description: "Generated deployments require exact reviewed plan and configuration revisions", Statuses: []int{422}},
...
var expectedOpenAPIOperationProblemCodes = map[string][]string{
	...
	"deployApplication":                         {"application_busy", "reviewed_revision_stale", "reviewed_revisions_required"},
	...
	"startDefaultGitHubDeviceConnection":        {"authentication_required", "provider_unavailable"},
	"pollGitHubDeviceConnection":                {"authentication_required", "source_access_lost", "provider_unavailable"},
	"pollDefaultGitHubDeviceConnection":         {"authentication_required", "authorization_identity_mismatch", "authorization_superseded", "authorization_failed", "provider_unavailable"},
	"listDefaultGitHubRepositories":             {"source_access_lost", "provider_unavailable", "source_too_large"},
