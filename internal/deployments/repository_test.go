...
func TestSourceFailureDiagnosticTaxonomyIsSanitized(t *testing.T) {
	for _, code := range []string{"invalid_source", "source_unavailable", "source_access_lost", "source_too_large", "source_storage_full", "provider_unavailable", "configuration_unavailable", "configuration_review_required", "build_configuration_requires_build_command"} {
		fixture := newRepositoryFixture(t)
		deployment := fixture.localDeployment(t)
