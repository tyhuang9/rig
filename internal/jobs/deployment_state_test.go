...
func TestRealDeploymentCompletionAndFailuresAreCentrallySanitized(t *testing.T) {
	...
	want := map[string]string{
		...
		"configuration_review_required":              "Review application configuration scope against the accepted deployment plan",
		"build_configuration_requires_build_command": "Public build configuration requires a reviewed build command",
